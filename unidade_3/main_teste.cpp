...
{
    float tempoT1 = ((100 - v_T1) / 100 * v_max);
    while (1)
    {
        std::cout << "Trem1: Trilho 2" << std::endl;
        ...
        std::cout << "Trem1: Trilho 3" << std::endl;
        ...
        std::cout << "Trem1: Trilho 4" << std::endl;
        sprite->setPosition(t1px, t1py + trailw / 2);
        usleep(tempoT1);

        mutexT2.unlock();

        std::cout << "Trem1: Trilho 1" << std::endl;
        sprite->setPosition(t1px - trailw / 2, t1py);
        usleep(tempoT1);
    }
}
...
{
    float tempoT2 = ((100 - v_T2) / 100 * v_max);
    while (1)
    {
        std::cout << "Trem2: Trilho 5" << std::endl;
        sprite->setPosition(t2px, t2py - trailw / 2);
        usleep(tempoT2);

        std::cout << "Trem2: Trilho 6" << std::endl;
        ...
        std::cout << "Trem2: Trilho 7" << std::endl;
        sprite->setPosition(t2px, t2py + trailw / 2);
        usleep(tempoT2*2);
        ...
        std::cout << "Trem2: Trilho 3" << std::endl;
        sprite->setPosition(t2px - trailw / 2, t2py);
        usleep(tempoT2*2);
...
{
    float tempoT3 = ((100 - v_T3) / 100 * v_max);
    while (1)
    {
        std::cout << "Trem3: Trilho 10" << std::endl;
        sprite->setPosition(t3px, t3py + trailw / 2);
        usleep(tempoT3);

        std::cout << "Trem3: Trilho 8" << std::endl;
        ...
        std::cout << "Trem3: Trilho 4" << std::endl;
        sprite->setPosition(t3px, t3py - trailw / 2);
        usleep(tempoT3*2);
        ...
        std::cout << "Trem3: Trilho 9" << std::endl;
        sprite->setPosition(t3px + trailw / 2, t3py);
        usleep(tempoT3*2);
...
{
    float tempoT4 = ((100 - v_T4) / 100 * v_max);
    while (1)
    {
        std::cout << "Trem4: Trilho 12" << std::endl;
        ...
        std::cout << "Trem4: Trilho 9" << std::endl;
        ...
        std::cout << "Trem4: Trilho 7" << std::endl;
        sprite->setPosition(t4px, t4py - trailw / 2);
        usleep(tempoT4*2);

        mutexT3.unlock();

        std::cout << "Trem4: Trilho 11" << std::endl;
        sprite->setPosition(t4px + trailw / 2, t4py);
        usleep(tempoT4);
    }
}
...
int main()
{
    ...
    T1Sprite.setPosition(t1px - trailw / 2, t1py);

    sf::String T1Input("50");
    sf::Text T1Text;
    T1Text.setFont(font);
    T1Text.setFillColor(sf::Color::Black);
    ...
    T1Label.setFillColor(sf::Color::White);
    ...
    sf::Text T2Text;
    T2Text.setFont(font);
    T2Text.setFillColor(sf::Color::Black);
    ...
    T2Label.setFillColor(sf::Color::White);
    ...
    sf::Text T3Text;
    T3Text.setFont(font);
    T3Text.setFillColor(sf::Color::Black);
    ...
    T3Label.setFillColor(sf::Color::White);
    ...
    T4Sprite.setPosition(t4px + trailw / 2, t4py);

    sf::String T4Input("50");
    sf::Text T4Text;
    T4Text.setFont(font);
    T4Text.setFillColor(sf::Color::Black);
    ...
    T4Label.setFillColor(sf::Color::White);
